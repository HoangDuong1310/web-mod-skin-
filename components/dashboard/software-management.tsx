...
import { Package, Plus, Download, Search, Edit, Trash2, Eye, Star, Copy, Code } from 'lucide-react'
...
export default function SoftwareManagement() {
  ...
  const [apiTypeIndex, setApiTypeIndex] = useState<{[key: string]: number}>({})

  const copyAPIEndpoint = (id: string) => {
    try {
                    ...
                    <TableRow key={item.id}>
                      ...
                      <TableCell>
                        <div className="font-medium">
                          {Number(item.price) === 0 ? 'Free' : formatCurrency(item.price)}
                        </div>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        <div className="flex items-center space-x-1">
                          <Button
                            ...
                            title={`Copy ${apiTypes[(apiTypeIndex[item.id] || 0)].label} (Click to cycle)`}
